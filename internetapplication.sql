...
DROP DATABASE IF EXISTS `internetapplication`;
CREATE DATABASE IF NOT EXISTS `internetapplication` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `internetapplication`;
